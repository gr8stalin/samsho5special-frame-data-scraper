...
class TableParser(object):
    ...
    def extractMovesFromTable(self):
        ...
        for moveRow in self.tableRows:
            ...
            finalData["Damage"] = int(moveData[1].text)
            finalData["Startup"] = int(moveData[2].text)
            finalData["ActiveFrames"] = int(moveData[3].text)
            finalData["TotalFrames"] = int(moveData[4].text)
